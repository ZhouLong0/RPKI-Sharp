...
namespace RPKIdecoder.Stats
{
    class MRT
    {
        public static void MRTWriteResult()
        {
            ...
            FileInfo file = new FileInfo(@"C:\Users\zhoul\Desktop\ReposData\2017\bview.20170601.0000");
                ...
                //if (start == true)
                {
                    foreach (TableDumpRIBEntry tdrEntry in mrtEntry.Entries)
                    {
                        ...
                        if (tdrEntry.Peer.PeerAS == 3333)
                        {
                            ...
                            TextWriter tsw1 = new StreamWriter(@"C:\Users\zhoul\Desktop\MRT_Results\2017\ResultTable.txt", true);
                            tsw1.WriteLine(tableLine);

                            TextWriter statsFile = new StreamWriter(@"C:\Users\zhoul\Desktop\MRT_Results\2017\Stats.txt");
                            stats.globalUpdate();
